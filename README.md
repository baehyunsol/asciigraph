...
fn main() {
    ...
    let mut g10 = Graph::new(60, 24);
    g10.set_1d_labeled_data(&(0..7854).map(
            |i| {
                let x = i as f64 / 1250.0;
                let y = x.sin();
        ...
        .set_y_max("1.2")
        .set_y_min("-1.2")
        .add_labeled_interval(0, 30, "first pi".to_string())
        .add_labeled_interval(31, 59, "second pi".to_string())
        .add_labeled_interval(0, 59, "two pi".to_string())
        .add_labeled_interval(0, 4, "small interval".to_string())
        .add_labeled_interval(12, 22, "small interval2".to_string());
...
-0.8│███████████████████████████████████████▄▄        ▄▄█████████
  ...
  -1│████████████████████████████████████████████████████████████
    │████████████████████████████████████████████████████████████
    ╰────────────────────────────────────────────────────────────
     0  0.4176  1.2552  2.0936  2.9312  3.7688  4.6064  5.444
      0.208  0.8376  1.6752  2.5128  3.3504  4.1888  5.0264
     <──────────first pi───────────><─────────second pi─────────>
     <──────────────────────────two pi──────────────────────────>
     <───>       <─smal...─>
```